...
const renderStudents = async () => {
  ...
  <input class="table__mark" disabled value="8" data-mark="${student.student_id}"></input>
  <div class="table__edit" data-editShow>
    <div class="btn btn-square btn-gray" data-edit="${student.student_id}">
      <svg data-edit="${student.student_id}" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="table__btn-container" data-remove="${student.student_id}">
      <span>Удалить</span>
